...
Figure~\ref{fig:QQ_GMWB} shows the QQ plots between the \textbf{true} labels and the metamodel predictions.
We see that the LSTM metamodels' QQ-plots closely follow that 45-degree line.
...
An accurate identification of the true tail scenarios is crucial for the two-stage procedure to produce accurate CVaR estimates.
