...
\begin{table}[ht!]
    ...
    \begin{tabular}{lccccc}
        ...
        High-capacityLSTM   & $N=1$                                     & $0.977 (\pm0.026)$        &                       & $0.378 (\pm0.017)$ \\
        \bottomrule
    \end{tabular}
...
Table~\ref{tab:lstm_sens} shows the average squared errors between the regular LSTM predictions and the true losses for various combinations of $M$ and $N$.
