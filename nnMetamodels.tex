...
In this section, we treat the standard nested simulation procedure as a data generator and examine the noise tolerance of LSTM metamodels by varying the number of inner replications used to generate the training labels.
...
\begin{table}[ht!]
    ...
    \begin{tabular}{lccccc}
        ...
        \midrule
        Low-capcity  LSTM     & Low & $0.086 (\pm0.004)$ & $0.093 (\pm0.004)$ & $0.074 (\pm0.004)$ \\
        High-capacity LSTM    & Low & $0.000 (\pm0.000)$ & $0.000 (\pm0.000)$ & $0.000 (\pm0.000)$ \\
        Low-capcity  LSTM     & Medium & $0.000 (\pm0.000)$ & $0.000 (\pm0.000)$ & $0.000 (\pm0.000)$ \\
        High-capacity LSTM    & Medium & $0.000 (\pm0.000)$ & $0.000 (\pm0.000)$ & $0.000 (\pm0.000)$ \\
        Low-capcity  LSTM     & High & $0.000 (\pm0.000)$ & $0.000 (\pm0.000)$ & $0.000 (\pm0.000)$ \\
        High-capacity LSTM    & High & $0.000 (\pm0.000)$ & $0.000 (\pm0.000)$ & $0.000 (\pm0.000)$ \\
        \bottomrule
    \end{tabular}
...
Table~\ref{tab:lstm_arch} shows the average squared errors between the metamodel predictions and the labels in different datasets.
The standard errors of these quantities are also reported in parentheses.
