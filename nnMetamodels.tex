...
For each metamodel, 50 independent macro replications are run\footnote[1]{Each macro replication includes simulating a noisy dataset, separating it into training and test data, fitting a metamodel, and making predictions}.
...
Figure~\ref{fig:tailMatches} depicts the average percentage\footnote[2]{The average percentage is calculated based on 50 macro replications.} of correctly identified true tail scenarios by different metamodels for different safety margins.
