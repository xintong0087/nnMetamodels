...
\begin{table}[ht!]
    ...
    \begin{tabular}{lccccc}
        ...
        \midrule
        LSTM                & $N=100$                                   & $0.082 (\pm0.004)$        &                       & $0.070 (\pm0.004)$ \\ 
        High-capacity LSTM  & $N=100$                                   & $0.048 (\pm0.002)$        &                       & $0.060 (\pm0.002)$ \\
        LSTM                & $N=10$                                    & $0.195 (\pm0.001)$        &                       & $0.070 (\pm0.001)$ \\
        High-capacity LSTM  & $N=10$                                    & $0.157 (\pm0.002)$        &                       & $0.065 (\pm0.001)$ \\
        LSTM                & $N=1$                                     & $1.366 (\pm0.006)$        &                       & $0.129 (\pm0.002)$ \\
        LSTM                & $N=1$                                     & $0.977 (\pm0.026)$        &                       & $0.378 (\pm0.017)$ \\
        \bottomrule
    \end{tabular}
...
The test errors are omitted since we are not interested in generalization to noisy labels but to the true noiseless feature-label relationship.
...
Trained using low noise and medium noise labels, high-capacity LSTM metamodel consistently produces CVaR estimates that are closer to the true value than the low-capacity LSTM, while the other metamodels produce even worse estimates.
