...
\begin{table}[ht!]
    ...
    \begin{tabular}{lccccccc}
        ...
        RNN     & $(240, 32), (240, 4), 32$ & $32\!,\!021$ & $0.152 (\pm0.063)$ & $0.170 (\pm0.067)$ & $0.150 (\pm0.063)$ \\
        LSTM    & $(240, 32), (240, 4), 32$ & $35\!,\!729$ & $0.082 (\pm0.006)$ & $0.093 (\pm0.006)$ & $0.070 (\pm0.006)$ \\
        RNN$^*$ \footnotemark & $(240, 32), (240, 4), 32$ & $32\!,\!021$ & $0.109 (\pm0.010)$ & $0.143 (\pm0.013)$ & $0.100 (\pm0.010)$ \\
        \bottomrule
    \end{tabular}
...
\begin{table}[ht!]
    ...
    \begin{tabular}{lccccc}
        ...
        \midrule
        LSTM                & $N=100$                                   & $0.082 (\pm0.004)$        & $0.079(\pm0.005)$     & $0.070 (\pm0.004)$ \\ 
        High-capacity LSTM  & $N=100$                                   & $0.048 (\pm0.002)$        & $0.070(\pm0.003)$     & $0.060 (\pm0.002)$ \\
        ...
        High-capacityLSTM   & $N=1$                                     & $0.977 (\pm0.026)$        & $0.915(\pm0.008)$     & $0.378 (\pm0.017)$ \\
        \bottomrule
    \end{tabular}
...
\begin{table}[ht!]
    ...
    \begin{tabular}{lccccc}
        \toprule
                          & $N=1\!,\!000$ & $N=100$       & $N=10$        & $N=1$ \\
        \midrule
        $M = 100$         & $0.046$ & $0.062$ & $0.123$ & $0.754$ \\
        $M = 1\!,\!000$   & $0.051$ & $0.057$ & $0.147$ & $0.696$ \\
        $M = 10\!,\!000$  & $0.041$ & $0.037$ & $0.103$ & $0$ \\
        $M = 100\!,\!000$ & $0.034$ & $0.039$ & $0.063$ & $0.321$ \\
        \bottomrule
    \end{tabular}
...
\begin{figure}[ht!]
    ...
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\textwidth]{./figures/singleStage/CVaRhighNoise.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=\textwidth]{./figures/singleStage/MSEConvergence_lstmLoCap_MN.png}
...
\begin{figure}[ht!]
    \centering
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\textwidth]{./figures/qqPlots/rnnGood_training.png}
        \caption{A good RNN metamodel}
    \end{subfigure}\hfill
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\textwidth]{./figures/qqPlots/rnnBad_training.png}
        \caption{A bad RNN metamodel}
        \label{subfig:badRNN_training}
    \end{subfigure}
    \caption{QQ-plots between training labels (x-axis) and predicted losses (y-axis) for the RNN metamodel.} 
    \label{fig:QQ_RNN_training}
\end{figure}

\begin{figure}[ht!]
    \centering
    \includegraphics[width=\textwidth]{./figures/singleStage/CVaRlowNoise.png}
    \caption{CVaR estimates with low noise training labels ($N=100$)}
\end{figure}

\subsection{Black Scholes Results for a GMAB Contract}

In~\cite{dang2020efficient}, the authors propose a two-stage nested simulation procedure with a Black Scholes metamodel to estimate the 95\%-CVaR of the hedging loss of a GMAB contract.
...
\begin{table}[ht!]
    ...
    \begin{tabular}{lc}
        \toprule
        \textbf{Safety Margin}                  & Percentage of Matches \\
        \midrule
        $0\%$   & 0.57 \\
        $5\%$   & 0.89  \\
        $10\%$  & 0.92 \\
        \bottomrule
    \end{tabular}
    \caption{Percenatage of correctly identified true tails for a GMAB contract in~\cite{dang2020efficient}}
    \label{tab:jessica}
\end{table}
